...
if __name__=='__main__':
    ...
    # ============= Drift space  ===========================================#
    if caustics:
        Drift = SRWLOptD(0.9954254458 + cst_range[0] + defocus)  # container thickness
        logging.info('Caustics begin at: %.6f m' % (0.9954254458 + cst_range[0] + defocus))

    else:
        Drift = SRWLOptD(0.9954254458 + defocus)  # container thickness
        logging.info('Image at: %.6f' % (0.9954254458 + defocus))
